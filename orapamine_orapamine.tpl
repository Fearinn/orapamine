...
<div id="orp_gameArea" class="orp_gameArea">
  <div id="orp_boardContainer" class="orp_boardContainer whiteblock">
    <div id="orp_letterAxis-y" class="orp_axis-y" data-position="left">
      ...
      <div class="orp_axisValue">D</div>
      <div class="orp_axisValue">E</div>
      <div class="orp_axisValue">F</div>
    ...
    <div id="orp_letterAxis-x" class="orp_axis-x" data-position="bottom">
      ...
      <div class="orp_axisValue">L</div>
      <div class="orp_axisValue">M</div>
      <div class="orp_axisValue">N</div>
      <div class="orp_axisValue">O</div>
      <div class="orp_axisValue">P</div>
    ...
    <div id="orp_numberAxis-x" class="orp_axis-x" data-position="top">
      ...
      <div class="orp_axisValue">4</div>
      <div class="orp_axisValue">5</div>
      <div class="orp_axisValue">6</div>
      <div class="orp_axisValue">7</div>
      <div class="orp_axisValue">8</div>
    ...
    <div id="orp_numberAxis-y" class="orp_axis-y" data-position="right">
      ...
      <div class="orp_axisValue">14</div>
      <div class="orp_axisValue">15</div>
      <div class="orp_axisValue">16</div>
      <div class="orp_axisValue">17</div>
      <div class="orp_axisValue">18</div>
    </div>
    <div id="orp_board" class="orp_board">
      <div class="orp_cell"></div>
      <div class="orp_cell"></div>
      <div class="orp_cell"></div>
      <div class="orp_cell"></div>
      <div class="orp_cell"></div>
